        ...
        <div className="md:flex">
            ...
            <div className="p-8 flex flex-col justify-between">
                <div>
                    ...
                    <p className="mt-4 text-2xl font-bold text-primary-600 dark:text-primary-400">{product.price} ر.س</p>
                    <p className="mt-4 text-gray-500 dark:text-gray-300 text-lg">{product.description}</p>
                </div>
                <div className="mt-8">
                    <a href={`#/order/${product.id}`} className="inline-block px-8 py-3 text-lg font-semibold text-white transition-colors duration-300 transform bg-primary-600 rounded-lg hover:bg-primary-500 focus:outline-none focus:bg-primary-500">
                        اطلب الآن
                    </a>
