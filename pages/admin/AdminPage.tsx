...
const AdminPage: React.FC<AdminPageProps> = ({ products, adminConfig, onSave, onSaveConfig }) => {
  ...
  return (
    <div className="space-y-12">
      ...
      {/* Settings Management */}
      <div>
        <h1 className="text-3xl font-bold text-gray-800 dark:text-white mb-6">إعدادات المتجر</h1>
